...
export default function Peak() {
  ...
  return (
    <section className={styles.section} id="moment" aria-labelledby="moment-title">
          ...
          <div className={styles.overlay}>
            <div className={styles.copy}>
              ...
              <Reveal as="h2" className={styles.title} delay={170}>
                <span id="moment-title" className={styles.t1}>
                  音が変わる瞬間を、毎回つくる。
                </span>
