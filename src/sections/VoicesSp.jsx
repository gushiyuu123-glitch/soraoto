...
const VOICES = [
  {
    no: "01",
    meta: "大人 / 再開",
    quote: "弾けない原因が「指」じゃなくて、姿勢とテンポだと分かっただけで、音が変わりました。",
    after: "“家で直せる量だけ”が、いちばん効く。",
  },
  {
    no: "02",
    meta: "小学生 / はじめて",
    quote: "できない所を叱られないのに、次の週にはちゃんとできるようになってて、本人が嬉しそうでした。",
    after: "親として、安心して任せられる感じ。",
  },
  {
    no: "03",
    meta: "伴奏 / 期限あり",
    quote: "毎回ひとつだけ直すから、練習が迷子にならない。帰り道に「もう一回弾く」が本当に起きます。",
    after: "短い期間でも、積み上がる。",
  },
];
...
export default function VoicesSp() {
  return (
    <section className={styles.section} id="voices-sp" aria-labelledby="voices-title-sp">
      <div className={styles.inner}>
        ...
        <Reveal as="h2" className={styles.title} delay={140}>
          <span id="voices-title-sp" className={styles.t1}>
            声の例を、3つ置きます。
          </span>
